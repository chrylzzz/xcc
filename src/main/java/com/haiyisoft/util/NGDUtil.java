...
//                "}";
        ...
        log.info("开始调用百度知识库接口:{}", param.toJSONString());
        String jsonStrResult = HttpClientUtil.doPostJsonForGx(IVRInit.XCC_CONFIG_PROPERTY.getNgdQueryUrl(), param.toJSONString());
...
//        String sessionId = dataJson.getString("sessionId");
     ...
     * @return
     */
    public static IVREvent convertResText(String glResText, IVREvent ivrEvent) {
        String retKey = "";//指令
        ...
        ivrEvent.setRetKey(retKey);
        ivrEvent.setRetValue(retValue);
        log.info("convertResText ivrEvent: {}", ivrEvent);
        return ivrEvent;
    }

...
//                    .setSocketTimeout(2500) //设置数据超时时间

                    .setConnectTimeout(10000) //连接超时时间
                    .setConnectionRequestTimeout(10000) //从线程池中获取线程超时时间
                    .setSocketTimeout(10000) //设置数据超时时间
...
//                    .setSocketTimeout(2000)
            ...
            httpPost.setEntity(entity);
            //设置广西ivr-bot id
            httpPost.setHeader("Authorization", IVRInit.XCC_CONFIG_PROPERTY.getNgdQueryAuthorization());
